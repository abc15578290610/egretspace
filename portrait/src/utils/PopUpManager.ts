...
module game.PopUpManager {
    ...
    */
	export function addPopUp(panel, dark: boolean = false, popUpWidth: number = 0, popUpHeight: number = 0, effectType: number = 0, isAlert: boolean = false, close: boolean = true): void {
