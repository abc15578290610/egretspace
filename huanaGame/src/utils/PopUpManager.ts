...
module game.PopUpManager {
    ...
    */
	export function addPopUp(panel, dark: boolean = false, popUpWidth: number = 0, popUpHeight: number = 0, effectType: number = 0, isAlert: boolean = false, close: boolean = true,Layer=GameLayerManager.gameLayer().panelLayer): void {
    ...
    */
	export function removePopUp(panel, effectType: number = 0,Layer=GameLayerManager.gameLayer().panelLayer): void {
		...
		if (this.darkSprite&&Layer.contains(this.darkSprite)) {
