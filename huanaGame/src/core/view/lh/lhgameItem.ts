module game {
	export class lhgameItem extends gameItem{
		public data:any[];
		...
		public initData(data:any){
			...
			this.m_roomId.text = "龙虎-"+this.data[11];
			...
			// bjlstr = 'aaaaeeeeeeeeeiiieeajjjaabbb'
			let info = bjlstr.split('').reduce((p, k) => (p[k]++ || (p[k] = 1), p), {})
			this['r_1'].text = info['a']||0+'';
			this['r_2'].text = info['b']||0+'';
			this['r_3'].text = info['c']||0+'';
			if(this.data[5]){
