module game {
	...
	export class lhLib {
		...
		private m_space=12;
		private type=0;
		private static _instance: lhLib;
		public static getInstance(): lhLib {
			
			this._instance = new lhLib();
		 ...
		 * 
		 */
		public getLuTu(type,lib){
			return new lhLuTu(type).init(lib.dataTable,lib.layout);
		}
		public getlayOut(){
			return this.layout
		}
